...
const defaultProps = {
  ...
  data: null,
  loader, // TilesetIonLoader, I3SLoader,
...
export default class Tile3DLayer extends CompositeLayer {
  ...
  async _loadTileset(tilesetUrl) {
    ...
    const tilesetJson = load(tilesetUrl, loader);

    const tileset3d = new Tileset3D(
      tilesetJson,
      tilesetUrl,
      {
        // ion paramters
  ...
  _onTileError(tile, message, url) {
    this.props.onTileError(tile, message, url);
  }
